  ...
  <style>
    * {
    ...
    .hero-bg {
      ...
      width: 100%;
      height: 100%;
      background: url('images/panelwall3.jpg') center/cover;
      opacity: 0.3;
      z-index: -1;
    }
    ...
    <div class="login-card">
      ...
      <div class="login-hero">
        ...
        <div class="hero-content">
          ...
          <p class="hero-subtitle">Access your hospital dashboard to manage blood donations and coordinate with donors.</p>
      ...
      <div class="login-form-section">
        <div class="form-header">
          <h2 class="welcome-title">Hospital Login</h2>
          <p class="welcome-subtitle">Sign in to access your hospital dashboard</p>
        </div>

        <?php if (!empty($hospital_login_error)): ?>
        <div class="error-message">
          <i class="fas fa-exclamation-triangle"></i>
          <?php echo htmlspecialchars($hospital_login_error); ?>
        </div>
        <?php endif; ?>
        ...
        <div class="links-section">
          <div class="links">
            ...
            <button class="signup-btn" onclick="window.location='hospital_signup.php'">Sign Up</button>
          </div>
          <div class="links alt-login">
            <span>Are you a Donor? <a href="donor_login.php">Login Here</a></span>
          </div>
        </div>
      </div>
    </div>
